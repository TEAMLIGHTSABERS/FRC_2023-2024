...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 0.5; //(default 4.8)
    public static final double kMaxAngularSpeed = Math.PI/6; // radians per second (default 2 * Math.PI )
